...
final List<Therapist> therapistsList = [
  ...
  Therapist(id: '6', name: 'Жеймс', surname: 'Жонсон', experience: 12, costOfServices: 3000, mainSpecialization: 'Поведенческий психолог, Рационально-эмоциональный-терапевт', avatar: 'i.pravatar.cc/700?img=53'),
  Therapist(id: '7', name: 'Патрик', surname: 'Лоуренс', experience: 15, costOfServices: 3500, mainSpecialization: 'Женский психолог, Психодинамический-терапевт', avatar: 'i.pravatar.cc/700?img=59'),
  Therapist(id: '8', name: 'Жефри', surname: 'Перес', experience: 10, costOfServices: 1500, mainSpecialization: 'Перинатальный психолог, Интегративный-терапевт', avatar: 'i.pravatar.cc/700?img=68'),
  Therapist(id: '9', name: 'Синтия', surname: 'Лоу', experience: 11, costOfServices: 4500, mainSpecialization: 'Подростковый психолог, Рационально-эмоциональный-терапевт', avatar: 'i.pravatar.cc/700?img=49'),
  Therapist(id: '10', name: 'Мэри', surname: 'Кеннеди', experience: 7, costOfServices: 6500, mainSpecialization: 'Женский психолог, Интегративный-терапевт', avatar: 'i.pravatar.cc/700?img=16'),
  Therapist(id: '11', name: 'Гвендолин', surname: 'Роберсон', experience: 8, costOfServices: 900, mainSpecialization: 'Когнитивный психолог психолог, гештальт-терапевт', avatar: 'i.pravatar.cc/700?img=26'),
